# ipfs 与react 与区块链结合的demo

# 第一步 前期的准备工作

- 在http://ipfs.io安装ipfs 配置好跨域
...
- 打开另一个终端,输入 truffle develop 开启truffel终端编译合约
...
- 唤醒 metamask ,点击 submit
 ![](./show.jpeg)

- 如果value 改为了5 ,说明前期成功部署结束
